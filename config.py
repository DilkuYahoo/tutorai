...
Summary of Recommendations Include a clear executive summary with actionable insights, such as:

"We recommend you invest $XXX,XXX in a balanced portfolio aligned with your risk profile. We also recommend you adjust your total insurance exposure as follows: reduce your income protection coverage from $X to $Y and change providers to reduce your annual premium by $Z. These changes are expected to maintain adequate cover while improving cost-efficiency in retirement.”
...
Align investment portfolio with client’s risk profile and retirement horizon
  ...
  Each fund should include the following details:
  | ASX Listed Fund | ASX Code | Allocation (% & AUD) | Rationale with clear explanation including Who is Vanguard, What does this fund do, Why we recommend the fund | Comparative Analysis (Alternative Fund & Justification) |
...
“We recommend you reduce your income protection insurance from $X to $Y annually. Based on our market comparison, switching to Provider ABC will save approximately $Z per year while retaining comparable cover. This aligns with your post-retirement income needs and reduces unnecessary premiums.”
...
Include a mix of life, health, income protection, and property insurance, with emphasis on critical areas like medical expenses, disability, and asset protection.  
Exclusion Criteria:  
Exclude insurance providers with a history of poor customer service or unresolved complaints in the past 12 months. The excluded list is: [Insert excluded providers here, if applicable].  
